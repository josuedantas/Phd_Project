...
int calcTemplate1(cv::Mat imgInt){
...
int calcTemplate2(cv::Mat imgInt){
int contV = 0, qtd = 0;
bool sem1 = false;
int fator = 0, jfinal = 0, ifinal = 0, tam = 3;
double dist = 0;
...
int calcTemplate3(cv::Mat imgInt){
int contV = 0, qtd = 0;
bool sem1 = false;
int fator = 0, jfinal = 0, ifinal = 0, tam = 3;
double dist = 0;
...
int calcTemplate4(cv::Mat imgInt){
int contV = 0, qtd = 0;
bool sem1 = false;
...
double getVenation(string path, int tp){
int total1 = 0, total2 = 0, total3 = 0, total4 = 0;
double media = 0,var = 0, dp = 0,coef = 0;
int res = 0;
cv::Mat imgIntegral, imgInt2,imgInt45, saida;
...
//saida.create(roi.rows,roi.cols,CV_8UC1);
    //double distance = 0;
total1 = calcTemplate1(imgIntegral);
total2 = calcTemplate2(imgIntegral);
total3 = calcTemplate3(imgInt45);
total4 = calcTemplate4(imgInt45);
...
clock_t t1,t2,t3,t4;
t1=clock();
std::string path = "./LeavesSelection/teste.txt";
...
if(myfile.is_open()){
 while (getline(myfile, line))
  {
    ...
    tipo = stoi(line.substr(line.find('\t'),line.size()-1));
    //cout<<first<<" "<<tipo<<"\n";

    result = getVenation("./LeavesSelection/"+first,tipo);
 ...
 cout << seconds3<<"\n";
 cout << "Tempo médio " << seconds3/totalfolhas<<"\n";
 ...
 imshow(windowName, saida); // Show our image inside the created window.
